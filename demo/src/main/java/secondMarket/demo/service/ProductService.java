...
public class ProductService {
    ...
    public Boolean adminDeleteProduct(Long productId){
        ...
        int resultImageU = imageRepository.adminDelete(productId);
    ...
    public boolean UserDeleteProduct(Long productId, Long memberId){
        ...
        int resultImageU = imageRepository.userDelete(productId,memberId);
        long resultProduct = productRepository.UserDelete(productId,memberId);
